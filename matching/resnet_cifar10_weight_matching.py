...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=2048,
                                            shuffle=True, num_workers=2)

    testset = datasets.CIFAR10(root='./data', train=False,
                                        download=True, transform=transform)
    test_loader = torch.utils.data.DataLoader(testset, batch_size=2048,
    ...
    plt.savefig(f"cifar10_resnet_weight_matching_interp_accuracy_epoch.png", dpi=300)
